...
class TestUserService(BaseTestCase):
    ...
    def test_all_users(self):
        ...
        with self.client:
            ...
            self.assertIn('elmer.thomas@gmail.com',
                          data['data']['users'][0]['email'])
            self.assertIn('thinkingserious',
                          data['data']['users'][1]['username'])
            self.assertIn('elmer@thinkingserious.com',
    ...
    def test_main_with_users(self):
        ...
        self.assertIn(b'<strong>elmer</strong>', response.data)
        self.assertIn(b'<strong>thinkingserious</strong>', response.data)
    ...
    def test_main_add_user(self):
        ...
        with self.client:
            response = self.client.post(
                '/',
                data=dict(username='elmer', email='elmer.thomas@gmail.com'),
